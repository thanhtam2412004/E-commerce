...
const seedProducts = [
  { name: 'Matcha Mộc Châu Cổ Điển', slug: 'matcha-moc-chau-co-dien', tag: 'Focus', cat: 'Ceremonial Grade', desc: 'Vị umami đậm, hậu ngọt thanh — lý tưởng cho buổi sáng tập trung.', price: 285000, rawPrice: 285000, stock: 48, grad: 'linear-gradient(150deg,#DCE6C8,#B9C9A6)', images: ['/images/matcha-moc-chau-co-dien.png'], isFeatured: true },
  ...
  { name: 'Matcha Fresh Latte', slug: 'matcha-fresh-latte', tag: 'Energy', cat: 'Đồ uống pha sẵn', desc: 'Matcha latte đóng chai mịn màng, thanh mát — sẵn sàng thưởng thức mọi lúc.', price: 69000, rawPrice: 69000, stock: 60, grad: 'linear-gradient(150deg,#DCE8D2,#A8C49A)', images: ['/images/matcha-fresh-latte.png'], isFeatured: false },
