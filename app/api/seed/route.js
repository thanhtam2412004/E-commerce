...
const seedProducts = [
  { name: 'Matcha Mộc Châu Cổ Điển', slug: 'matcha-moc-chau-co-dien', tag: 'Focus', cat: 'Ceremonial Grade', desc: 'Vị umami đậm, hậu ngọt thanh — lý tưởng cho buổi sáng tập trung.', price: 285000, rawPrice: 285000, stock: 48, grad: 'linear-gradient(150deg,#DCE6C8,#B9C9A6)', isFeatured: true },
  { name: 'Matcha Genki Boost', slug: 'matcha-genki-boost', tag: 'Energy', cat: 'Đặc tuyển', desc: 'Kết hợp matcha và nhân sâm nhẹ — năng lượng bền vững.', price: 320000, rawPrice: 320000, stock: 32, grad: 'linear-gradient(150deg,#F3E3C2,#D9AE6C)', isFeatured: true },
  { name: 'Matcha Lavender Calm', slug: 'matcha-lavender-calm', tag: 'Calm', cat: 'Đêm thư giãn', desc: 'Hoà quyện oải hương dịu nhẹ — làm chậm nhịp sống.', price: 305000, rawPrice: 305000, stock: 25, grad: 'linear-gradient(150deg,#E4D9E8,#C9B8D6)', isFeatured: false },
  { name: 'Matcha Glow Collagen', slug: 'matcha-glow-collagen', tag: 'Beauty', cat: 'Chăm sóc da', desc: 'Bổ sung collagen thuỷ phân — làn da căng mướt.', price: 349000, rawPrice: 349000, stock: 20, grad: 'linear-gradient(150deg,#F0D8DC,#E0AEB6)', isFeatured: true },
  { name: 'Matcha Immune Shield', slug: 'matcha-immune-shield', tag: 'Immunity', cat: 'Đề kháng', desc: 'Bổ sung vitamin C tự nhiên — tăng cường đề kháng.', price: 315000, rawPrice: 315000, stock: 40, grad: 'linear-gradient(150deg,#D8E8DC,#A8C9B0)', isFeatured: false },
